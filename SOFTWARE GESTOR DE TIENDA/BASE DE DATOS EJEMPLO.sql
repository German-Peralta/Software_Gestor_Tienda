...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2021 a las 17:17:23
...
INSERT INTO `clientes` (`DNI`, `NOMBRE`, `APELLIDOS`, `TELEFONO`, `CALLE`, `NUMERO`, `CODIGO POSTAL`, `CIUDAD`) VALUES
('41256398P', 'Javier', 'Sanchez Dominguez', 652589633, 'Ezcurdia', 23, 33210, 'Gijon'),
('47415862T', 'Marcos', 'Ribas Alonso', 652369688, 'La estepa', 15, 33210, 'Gijon'),
('54125874X', 'Pedro', 'Gomez Salas', 611258369, 'La Mancha', 23, 33210, 'Gijon');
...
(1452562583, 10, 'LG MH6336GIB', 'Microondas LG MH6336GIB 1000W Grill', '100.00', '140.00', 4, 4, 3),
(1472573542, 5, 'TV Schneider ', 'Televisor con tecnología LED ', '150.00', '220.00', 21, 21, 1),
(1593571598, 10, 'Xiaomi Redmi 9', 'Movil Xiaomi Gris 4 GB RAM', '120.00', '180.00', 10, 10, 2),
(1598524569, 5, 'Cecotec Mambo ', 'Robot de cocina Cecotec Mambo 10090 30 funciones', '250.00', '300.00', 21, 21, 3),
(2584561598, 8, 'Samsung Galaxy ', 'Móvil Samsung Galaxy A12 (2021) Negro 3 GB RAM', '100.00', '150.00', 4, 4, 2);
...
INSERT INTO `proveedores` (`CIF`, `RAZON SOCIAL`, `TELEFONO`, `WEB`, `CALLE`, `NUMERO`, `CODIGO POSTAL`, `CIUDAD`) VALUES
('A62348107', 'MEDIA MARKT SA', '913537200', 'www.mediamarkt.es', 'Paseo castellana', '20', '28009', 'Madrid'),
('B82140633', 'WORTEN ESPAÑA SL', '918386100', 'www.worten.es', 'Ramirez de arellano', '21', '28043', 'Madrid'),
('B96056494', 'MILAR ESPAÑA SL', '961721738', 'www.milar.es', 'Paseo del sol', '30', '46005', 'Valencia');
