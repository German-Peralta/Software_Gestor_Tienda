...
/**
 *Esta clase se encarga de aplicar el fitro de razon social de la tabla despues que el usuario libere la pulsación de una tecla en el cuadro de texto
 * @author GERMAN
 */
public class Controlador_Formulario_Ver_Proveedores_Digitacion_filtro_razon_social extends KeyAdapter{
   ...
   public void keyReleased(KeyEvent ke){
      ...
      organizador_tabla.setRowFilter(RowFilter.regexFilter("(?i)"+texto_filtro_nombre.getText(), 1));
