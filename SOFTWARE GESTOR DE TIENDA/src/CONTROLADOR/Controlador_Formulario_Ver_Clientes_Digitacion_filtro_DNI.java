...
/**
 *Esta clase se encarga de aplicar el fitro de DNI de la tabla despues que el usuario libere la pulsación de una tecla en el cuadro de texto
 * @author GERMAN
 */
public class Controlador_Formulario_Ver_Clientes_Digitacion_filtro_DNI extends KeyAdapter{
