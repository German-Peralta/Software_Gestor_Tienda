...
/**
 *Esta clase se encarga de abrir un formulario de registro de cliente ante la pulsación de un botón
 * @author GERMAN
 */
public class Controlador_Formulario_Registro_Cliente_Abrir implements ActionListener{
