...
/**
 *Esta clase se encarga de aplicar el fitro de codigo de barras de la tabla despues que el usuario libere la pulsación de una tecla en el cuadro de texto
 * @author GERMAN
 */
public class Controlador_Formulario_Ver_Productos_Digitacion_filtro_codigo_barras extends KeyAdapter{
