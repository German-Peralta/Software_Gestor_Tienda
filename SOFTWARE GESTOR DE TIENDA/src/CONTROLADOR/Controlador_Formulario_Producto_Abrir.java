...
/**
 *Esta clase se encarga de abrir un formulario de seleccion de opciones de producto ante la pulsación de un botón
 * @author GERMAN
 */
public class Controlador_Formulario_Producto_Abrir implements ActionListener {
