...
import MODELO.Consulta_Ventas_Totales;
 ...
 * @author GERMAN
 */
public class Controlador_Formulario_Ver_Ventas_Inicio extends WindowAdapter{
    ...
    public void windowOpened(WindowEvent e){
        ...
        Formulario_Ver_Ventas marco=(Formulario_Ver_Ventas)e.getSource();
        ...
        ResultSet resultado=new Consulta_Ventas_Totales().Ejecuta_Consulta();
