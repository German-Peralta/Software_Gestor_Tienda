...
/**
 *Esta clase elimina un producto a la tabla de detalle de venta cuando se pulsa un botón
 * @author GERMAN
 */
public class Controlador_Formulario_Registro_Venta_Elimina_Producto implements ActionListener{
/**
 ...
 */
    public void actualiza_importes( Formulario_Registro_Venta marco){
    ...
    public void actionPerformed(ActionEvent ae) {
      ...
      Formulario_Registro_Venta marco=(Formulario_Registro_Venta)SwingUtilities.getWindowAncestor(boton_elimina_producto);
